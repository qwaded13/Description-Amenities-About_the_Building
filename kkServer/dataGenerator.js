...
let generator = function(batchSize, startID, csvFormat) {
  ...
  for (let i = startID; i < startID + batchSize; i++) {
    ...
    if (csvFormat) {
      ...
      records.push({
        id: i,
        description: description.slice(descriptionStart, descriptionStart + 300),
